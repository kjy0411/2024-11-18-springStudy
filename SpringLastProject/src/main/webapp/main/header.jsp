                            ...
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        ...
                                        <a class="dropdown-item" href="#">숙박</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="#">일정 여행</a>
                                        <a class="dropdown-item" href="#">테마 여행</a>
                                        <a class="dropdown-item" href="#">미식 투어</a>
                                        <a class="dropdown-item" href="#">체험 해양</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="../food/list.do">전체 목록</a>
                                        <a class="dropdown-item" href="#">검색</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="#">레시피 목록</a>
