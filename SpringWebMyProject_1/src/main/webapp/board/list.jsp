...
<body>
	<div class="container">
		<div class="row">
			<h3 class="text-center">일반 게시판</h3>
			<table class="table">
				<tr>
			...
			<table class="table">
				...
				<c:forEach var="vo" items="${list }">
					<tr>
						...
						<td width="45%"><a href="detail_before.do?no=${vo.no }">${vo.subject }</a></td>
				...
				<tr>
		         <td colspan="5" class="text-center">
		          ...
		          <c:forEach var="i" begin="${startPage }" end="${endPage }">
			          <a href="list.do?page=${i }" class="btn btn-sm ${i==curpage?'btn-warning':'btn-default' }">${i }</a>
		          </c:forEach>
