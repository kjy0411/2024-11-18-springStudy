 ...
 *   			?no=10 ... ?page=1
 *   			(int no)	(int page) => 받으려는 값의 데이터형이 같아야한다(String은 항상 사용 가능)
 *   
 *   			<input type=text name=name>
 *   			<input type=text name=subejct>
 *   			(String name, String subject) => 받으려는 태그의 name값과 변수명이 일치해야한다
 *   		=> 객체 사용이 가능
 *   		   ------------
 *   			Model => 전송
 *   			HttpServletRequest
...
public class RecipeController {
	// 스프링에 저장되있는 객체를 가지고 온다 => 스프링에서는지역변수는 제어가 불가능
